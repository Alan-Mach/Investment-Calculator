...
- use the format `./main.e mode=1 A=1000 c=1000 r=1 i=1 t=1 n=1`
    - Do not put spaces between each variable and their respective values. The only spaces are to separate variables apart.
...
- This program does not extrapolate what r or i may be when provides the rest of the variables
- Due to a computer's finite representation of numbers, the values in the last rows of the .csv file may be slightly off.
